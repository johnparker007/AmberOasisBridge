...
FABRIC_API FabricResult FabricSessionInitialise(FabricMachineSession *session);
FABRIC_API FabricResult FabricSessionReset(FabricMachineSession *session);
FABRIC_API FabricResult FabricSessionAdvance(FabricMachineSession *session, uint64_t elapsed_nanoseconds);
FABRIC_API FabricResult FabricSessionShutdown(FabricMachineSession *session);
FABRIC_API FabricResult FabricSessionSubmitInput(FabricMachineSession *session, const FabricInput *input);
FABRIC_API FabricResult FabricSessionGetCapabilities(FabricMachineSession *session, FabricCapabilities *capabilities);
FABRIC_API FabricResult FabricSessionGetSnapshot(FabricMachineSession *session, FabricMachineSnapshot *snapshot);
FABRIC_API FabricResult FabricSessionGetAudioFormat(FabricMachineSession *session, FabricAudioFormat *format);
FABRIC_API FabricResult FabricSessionReadAudio(FabricMachineSession *session, int16_t *samples,
                                               uint32_t frame_capacity, uint32_t *frames_written);
FABRIC_API FabricResult FabricSessionGetLastError(FabricMachineSession *session, char *buffer,
                                                  uint32_t buffer_size, uint32_t *required_size);
