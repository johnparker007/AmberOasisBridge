...
typedef unsigned int m68k_uint;
...
/* Allow for architectures that don't have 8-bit sizes */
	...
	INLINE sint MAKE_INT_8(m68k_uint value)
	{
...
/* Allow for architectures that don't have 16-bit sizes */
	...
	INLINE sint MAKE_INT_16(m68k_uint value)
	{
...
/* Allow for architectures that don't have 32-bit sizes */
	...
	#undef  uint32
	#define uint32  unsigned int
	INLINE sint MAKE_INT_32(m68k_uint value)
	{
...
class mc68000
{
	private:
		...
		m68k_uint m68ki_read_imm_16(void);
		m68k_uint m68ki_read_imm_32(void);
		
		/* Read data with specific function code */
		m68k_uint m68ki_read_8_fc  (m68k_uint address, m68k_uint fc);
		m68k_uint m68ki_read_16_fc (m68k_uint address, m68k_uint fc);
		m68k_uint m68ki_read_32_fc (m68k_uint address, m68k_uint fc);
		
		/* Write data with specific function code */
		void m68ki_write_8_fc (m68k_uint address, m68k_uint fc, m68k_uint value);
		void m68ki_write_16_fc(m68k_uint address, m68k_uint fc, m68k_uint value);
		void m68ki_write_32_fc(m68k_uint address, m68k_uint fc, m68k_uint value);
		
		/* Indexed and PC-relative ea fetching */
		m68k_uint m68ki_get_ea_pcdi(void);
		m68k_uint m68ki_get_ea_pcix(void);
		m68k_uint m68ki_get_ea_ix(m68k_uint An);
		
		/* Operand fetching */
		m68k_uint OPER_AY_AI_8(void);
		m68k_uint OPER_AY_AI_16(void);
		m68k_uint OPER_AY_AI_32(void);
		m68k_uint OPER_AY_PI_8(void);
		m68k_uint OPER_AY_PI_16(void);
		m68k_uint OPER_AY_PI_32(void);
		m68k_uint OPER_AY_PD_8(void);
		m68k_uint OPER_AY_PD_16(void);
		m68k_uint OPER_AY_PD_32(void);
		m68k_uint OPER_AY_DI_8(void);
		m68k_uint OPER_AY_DI_16(void);
		m68k_uint OPER_AY_DI_32(void);
		m68k_uint OPER_AY_IX_8(void);
		m68k_uint OPER_AY_IX_16(void);
		m68k_uint OPER_AY_IX_32(void);
		
		m68k_uint OPER_AX_AI_8(void);
		m68k_uint OPER_AX_AI_16(void);
		m68k_uint OPER_AX_AI_32(void);
		m68k_uint OPER_AX_PI_8(void);
		m68k_uint OPER_AX_PI_16(void);
		m68k_uint OPER_AX_PI_32(void);
		m68k_uint OPER_AX_PD_8(void);
		m68k_uint OPER_AX_PD_16(void);
		m68k_uint OPER_AX_PD_32(void);
		m68k_uint OPER_AX_DI_8(void);
		m68k_uint OPER_AX_DI_16(void);
		m68k_uint OPER_AX_DI_32(void);
		m68k_uint OPER_AX_IX_8(void);
		m68k_uint OPER_AX_IX_16(void);
		m68k_uint OPER_AX_IX_32(void);
		
		m68k_uint OPER_A7_PI_8(void);
		m68k_uint OPER_A7_PD_8(void);
		
		m68k_uint OPER_AW_8(void);
		m68k_uint OPER_AW_16(void);
		m68k_uint OPER_AW_32(void);
		m68k_uint OPER_AL_8(void);
		m68k_uint OPER_AL_16(void);
		m68k_uint OPER_AL_32(void);
		m68k_uint OPER_PCDI_8(void);
		m68k_uint OPER_PCDI_16(void);
		m68k_uint OPER_PCDI_32(void);
		m68k_uint OPER_PCIX_8(void);
		m68k_uint OPER_PCIX_16(void);
		m68k_uint OPER_PCIX_32(void);
		
		/* Stack operations */
		void m68ki_push_16(m68k_uint value);
		void m68ki_push_32(m68k_uint value);
		m68k_uint m68ki_pull_16(void);
		m68k_uint m68ki_pull_32(void);
		
		/* Program flow operations */
		void m68ki_jump(m68k_uint new_pc);
		void m68ki_jump_vector(m68k_uint vector);
		void m68ki_branch_8(m68k_uint offset);
		void m68ki_branch_16(m68k_uint offset);
		void m68ki_branch_32(m68k_uint offset);
		
		/* Status register operations. */
		void m68ki_set_s_flag(m68k_uint value);            /* Only bit 2 of value should be set (i.e. 4 or 0) */
		void m68ki_set_sm_flag(m68k_uint value);           /* only bits 1 and 2 of value should be set */
		void m68ki_set_ccr(m68k_uint value);               /* set the condition code register */
		void m68ki_set_sr(m68k_uint value);                /* set the status register */
		void m68ki_set_sr_noint(m68k_uint value);          /* set the status register */
		
		/* Exception processing */
		m68k_uint m68ki_init_exception(void);              /* Initial exception processing */
		
		void m68ki_stack_frame_3word(m68k_uint pc, m68k_uint sr); /* Stack various frame types */
		void m68ki_stack_frame_buserr(m68k_uint pc, m68k_uint sr, m68k_uint address, m68k_uint write, m68k_uint instruction, m68k_uint fc);
		
		void m68ki_stack_frame_0000(m68k_uint pc, m68k_uint sr, m68k_uint vector);
		void m68ki_stack_frame_0001(m68k_uint pc, m68k_uint sr, m68k_uint vector);
		void m68ki_stack_frame_0010(m68k_uint sr, m68k_uint vector);
		void m68ki_stack_frame_1000(m68k_uint pc, m68k_uint sr, m68k_uint vector);
		void m68ki_stack_frame_1010(m68k_uint sr, m68k_uint vector, m68k_uint pc);
		void m68ki_stack_frame_1011(m68k_uint sr, m68k_uint vector, m68k_uint pc);
		
		void m68ki_exception_trap(m68k_uint vector);
		void m68ki_exception_trapN(m68k_uint vector);
		...
		void m68ki_exception_interrupt(m68k_uint int_level);
		...
		char* make_signed_hex_str_8(m68k_uint val);
		char* make_signed_hex_str_16(m68k_uint val);
		char* make_signed_hex_str_32(m68k_uint val);
		char* get_imm_str_s(m68k_uint size);
		char* get_imm_str_u(m68k_uint size);
		char* get_ea_mode_str(m68k_uint instruction, m68k_uint size);
	...
	public:
		...
		typedef struct
		{
			...
			m68k_uint mask;                    /* mask on opcode */
			m68k_uint match;                   /* what to match after masking */
			m68k_uint ea_mask;                 /* what ea modes are allowed */
		} opcode_struct;
		typedef struct
		{
			void (mc68000::*opcode_handler)(void); /* handler function */
		...
		typedef struct
		{
			m68k_uint cpu_type;     /* CPU Type: 68000, 68010, 68EC020, or 68020 */
			m68k_uint dar[16];      /* Data and Address Registers */
			m68k_uint ppc;		   /* Previous program counter */
			m68k_uint pc;           /* Program Counter */
			m68k_uint sp[7];        /* User, Interrupt, and Master Stack Pointers */
			m68k_uint vbr;          /* Vector Base Register (m68010+) */
			m68k_uint sfc;          /* Source Function Code Register (m68010+) */
			m68k_uint dfc;          /* Destination Function Code Register (m68010+) */
			m68k_uint cacr;         /* Cache Control Register (m68020, unemulated) */
			m68k_uint caar;         /* Cache Address Register (m68020, unemulated) */
			m68k_uint ir;           /* Instruction Register */
			m68k_uint t1_flag;      /* Trace 1 */
			m68k_uint t0_flag;      /* Trace 0 */
			m68k_uint s_flag;       /* Supervisor */
			m68k_uint m_flag;       /* Master/Interrupt state */
			m68k_uint x_flag;       /* Extend */
			m68k_uint n_flag;       /* Negative */
			m68k_uint not_z_flag;   /* Zero, inverted for speedups */
			m68k_uint v_flag;       /* Overflow */
			m68k_uint c_flag;       /* Carry */
			m68k_uint int_mask;     /* I0-I2 */
			m68k_uint int_level;    /* State of interrupt pins IPL0-IPL2 -- ASG: changed from ints_pending */
			m68k_uint int_cycles;   /* ASG: extra cycles from generated interrupts */
			m68k_uint stopped;      /* Stopped state */
			m68k_uint pref_addr;    /* Last prefetch address */
			m68k_uint pref_data;    /* Data in the prefetch queue */
			m68k_uint address_mask; /* Available address pins */
			m68k_uint sr_mask;      /* Implemented status register bits */
		
			/* Clocks required for instructions / exceptions */
			m68k_uint cyc_bcc_notake_b;
			m68k_uint cyc_bcc_notake_w;
			m68k_uint cyc_dbcc_f_noexp;
			m68k_uint cyc_dbcc_f_exp;
			m68k_uint cyc_scc_r_false;
			m68k_uint cyc_movem_w;
			m68k_uint cyc_movem_l;
			m68k_uint cyc_shift;
			m68k_uint cyc_reset;
		...
		m68k_uint 			m68ki_address_space = 0;
		sint 			m68ki_remaining_cycles = 0;
		bool            m68ki_executing = false;

		static uint8          	m68ki_shift_8_table[];
		static uint16         	m68ki_shift_16_table[];
		static m68k_uint           	m68ki_shift_32_table[];

/*
extern m68k_uint           m68ki_tracing;
...
*/
		...
		m68k_uint *m68k_cpu_dar[2];
		m68k_uint* m68k_movem_pi_table[16];
		m68k_uint* m68k_movem_pd_table[16];
		...
		int m68k_add_cycles(int cycles);
		bool m68k_is_executing(void) const;
