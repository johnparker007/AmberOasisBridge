...
#define NUMMECHS 8
#define CPU_CYCLES_PER_SECOND 8000000

class JPMSystem6 : mc68000 {
protected:
...
private:
	...
	MarsMech*				Mars = new MarsMech(CPU_CYCLES_PER_SECOND);
...
public:
	...
	UINT32 __fastcall FillOutputSnapshot(PA2_OutputSnapshot* Out);
	...
	UINT8 MarsCoinIn(UINT8 Coin, UINT8 CoinValue);
